...
class Heading extends BlockFormat {
   ...
   */
  static getTagMap() {
    // Paragraph first: it's the "normal text" option users reach for to revert a
    // heading back to body text. Listing it on top makes that path obvious
    // instead of hiding it below the headings (where it was easy to miss).
    return {
      'P': { tag: 'P', element: '<span>Normal text</span>', title: 'Normal text' },
      'H1': { tag: 'H1', element: '<span>Heading 1</span>', title: 'Heading 1' },
      'H2': { tag: 'H2', element: '<span>Heading 2</span>', title: 'Heading 2' },
      'H3': { tag: 'H3', element: '<span>Heading 3</span>', title: 'Heading 3' },
      'H4': { tag: 'H4', element: '<span>Heading 4</span>', title: 'Heading 4' },
      'H5': { tag: 'H5', element: '<span>Heading 5</span>', title: 'Heading 5' },
      'H6': { tag: 'H6', element: '<span>Heading 6</span>', title: 'Heading 6' },
      'BLOCKQUOTE': { tag: 'BLOCKQUOTE', element: '<span>Quote</span>', title: 'Quote' },
      'PRE': { tag: 'PRE', element: '<span>Code</span>', title: 'Code' }
    };
  }
