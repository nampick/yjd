...
export default class Editor {
  ...
  loadModules() {
    ...
    if (hasToolbarConfig) {
      ...
      modulesToLoad = this.options.modules || ['toolbar', 'history', 'block-toolbar', 'table-toolbar', 'code-view', 'code-block-tools', 'block-handles', 'resize-handles', 'find-replace', 'slash-menu', 'mention'];
    }
