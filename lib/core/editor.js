...
export default class Editor {
  ...
  loadModules() {
    ...
    if (this.options.plainText) {
      ...
      modulesToLoad = this.options.modules || ['toolbar', 'history', 'block-toolbar', 'table-toolbar', 'code-view', 'code-block-tools', 'block-handles', 'side-panel', 'resize-handles', 'find-replace', 'slash-menu', 'mention', 'button'];
    }
