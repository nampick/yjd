...
export default class Editor {
  ...
  constructor(selector, options = {}) {
    ...
    console.log('Editor options:', this.options); // Debug log
  ...
  loadModules() {
    ...
    if (hasToolbarConfig) {
      ...
      console.log('🔧 Custom toolbar detected - loading basic modules only');
    } else {
      ...
      console.log('🎛️ No toolbar config - loading full feature set');
    }
  ...
  loadFormats() {
    ...
    if (hasToolbarConfig) {
      ...
      console.log('🔧 Custom toolbar detected - loading basic formats only');
    } else {
      // No toolbar config - load full feature set
      ...
      console.log('🎛️ No toolbar config - loading full formats');
    }
    
    console.log('Loading formats:', formatsToLoad);
    ...
    formatsToLoad.forEach(formatName => {
      ...
      if (FormatClass) {
        ...
        console.warn(`Format not found: ${formatName}`);
      }
    });
  }
