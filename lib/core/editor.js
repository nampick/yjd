...
export default class Editor {
  ...
  createStructure() {
    ...
    // Theme: 'light' (default) | 'dark' | 'auto' (follows the OS). Drives the
    // --rte-* tokens via [data-theme] in the stylesheet.
    this.wrapper.setAttribute('data-theme', this.options.theme || 'light');
  ...
  setTheme(theme) {
    ...
    this.wrapper.setAttribute('data-theme', t);
    this.emit('theme:change', t);
    return this;
  }

  /** @returns {string} The current theme option ('light'|'dark'|'auto'). */
  getTheme() {
