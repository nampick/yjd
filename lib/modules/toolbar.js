...
class Toolbar extends Module {
  ...
  addButton(container, format) {
    ...
    const customButtons = {
      'heading': { text: 'Paragraph', width: 'auto', title: 'Paragraph style' },
      'font-family': { text: 'Font Family', width: 'auto', title: 'Font' },
      'text-size': { text: 'Text Size', width: 'auto', title: 'Font size' }
    };
    ...
    button.title = (this.editor && typeof this.editor.t === 'function')
      ? this.editor.t('toolbar.' + format, enTitle) : enTitle;
    ...
    button.addEventListener('click', async (e) => {
      ...
      if (!this._addMenu) {
        ...
        this._addMenu = new AddMenu({
          anchor: button,
          items,
          head: this.editor.t('addMenu.head', 'Attach'),
    ...
    cfg.forEach((entry) => {
      ...
      if (typeof entry === 'string') {
        ...
        const label = (typeof this.editor.t === 'function')
          ? this.editor.t('addMenu.' + entry, item.label) : item.label;
