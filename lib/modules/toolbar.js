...
class Toolbar extends Module {
  ...
  constructor(editor, options = {}) {
    ...
    if (Array.isArray(options.toolbar)) {
      console.log('✅ Toolbar array detected:', options.toolbar);
      ...
      console.log('✅ Toolbar1/Toolbar2 config detected');
      ...
      console.log('❌ No custom toolbar config - using defaults');
      // Use full default configuration
      this.options = { ...Toolbar.DEFAULTS, ...options };
    }
    
    console.log('🔧 Final toolbar options:', this.options);
