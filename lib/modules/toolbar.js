...
class Toolbar extends Module {
  ...
  reflow() {
    ...
    // Build the single horizontally-scrollable overflow row: mono label, any
    // demoted primary groups, then the fixed overflow groups.
    ...
    this.overflowGroups.forEach(g => row.appendChild(g));
