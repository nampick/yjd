...
class Toolbar extends Module {
  static DEFAULTS = {
    ...
    toolbar2: [
      ...
      { group: 'insert', items: ['horizontal-rule'] },
      { group: 'clean', items: ['clear-format'] },
      { group: 'direction', items: ['text-direction'] },
      { group: 'find', items: ['find'] },
  ...
  toggleToolbar2() {
    ...
    if (moreButton) {
      moreButton.setAttribute('aria-expanded', this.toolbar2Visible ? 'true' : 'false');
      if (this.toolbar2Visible) {
