...
export default class FindReplace extends Module {
  ...
  buildPanel() {
    ...
    this.caseBtn = mkBtn('Aa', 'Match case', 'yjd-find-toggle');
    this.wordBtn = mkBtn('Whole word', 'Match whole words only', 'yjd-find-toggle');
    this.regexBtn = mkBtn('.*', 'Regular expression', 'yjd-find-toggle yjd-find-regex');
