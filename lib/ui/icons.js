...
export const Icons = {
  ...
  'cell-merge': S('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 12h5"/><path d="M16 12h5"/><path d="m11 9 3 3-3 3"/>'),
  'cell-split': S('<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 3v18"/><path d="m9 9-3 3 3 3"/><path d="m15 9 3 3-3 3"/>'),
  ...
  // AI assistant — sparkles (the universal "AI" affordance).
  ...
  'fullscreen-exit': S('<path d="M8 3v3a2 2 0 0 1-2 2H3"/><path d="M21 8h-3a2 2 0 0 1-2-2V3"/><path d="M3 16h3a2 2 0 0 1 2 2v3"/><path d="M16 21v-3a2 2 0 0 1 2-2h3"/>'),
