...
function createCustomButton(text = 'Button', options = {}) {
  ...
  // Theme-aware via tokens (these inline styles would otherwise beat the CSS
  // and force a light trigger in dark mode). Fallbacks keep light-mode parity.
  button.style.color = 'var(--rte-ink, #374151)';
  button.style.background = 'var(--rte-bg, #FFFFFF)';
  button.style.cursor = 'pointer';
  button.style.border = '1px solid var(--rte-border, #d1d5db)';
