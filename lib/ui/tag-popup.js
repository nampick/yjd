...
class TagPopup {
  ...
  createTagPopup() {
    ...
    title.textContent = this._t('tag.title', 'Insert tags');
    ...
    typeLabel.textContent = this._t('tag.type', 'Type');
    ...
    `;
    this.typeSelect.options[0].textContent = this._t('tag.mention', 'Mention');
    this.typeSelect.options[1].textContent = this._t('tag.hashtag', 'Hashtag');
    this.typeSelect.options[2].textContent = this._t('tag.custom', 'Custom');
    ...
    contentLabel.textContent = this._t('tag.content', 'Content');
    ...
    this.contentInput.placeholder = this._t('tag.contentPlaceholder', 'Please enter tag content');
    ...
    suggestionsLabel.textContent = this._t('tag.suggestions', 'Suggestions');
    ...
    this.insertButton.className = 'yjd-button-confirm button-disable';
    this.insertButton.textContent = this._t('tag.insert', 'Insert Tag');
  ...
  updateInsertButton() {
    ...
    this.insertButton.classList.toggle('button-disable', !hasContent);
  }
