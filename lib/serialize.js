...
function mediaMd(alt, src) {
  ...
  if (/\.(mp4|webm|ogg|mov|avi|mkv)(?:[?#]|$)/i.test(src)) return `<video class="inserted-video" src="${attr(src)}" controls style="max-width:100%;height:auto" contenteditable="false"></video>`;
