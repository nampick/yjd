...
import Code from './lib/formats/code.js';
...
import LetterSpacing from './lib/formats/letter-spacing.js';
...
import CodeBlockTools from './lib/modules/code-block-tools.js';
...
registry.register('formats/letter-spacing', LetterSpacing, true);
...
registry.register('modules/code-block-tools', CodeBlockTools, true);
registry.register('modules/block-handles', BlockHandles, true);
registry.register('modules/side-panel', SidePanel, true);
